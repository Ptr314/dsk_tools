...
## Инструменты разбора образов

В каталоге [tools](tools/) лежат скрипты на Python для анализа AIM-образов: разбор структуры
дорожек с поиском отклонений от стандарта, физический порядок секторов, извлечение
секторов по номеру из заголовка. Там же — [сводка нестандартных случаев](tools/aim-anomalies.md),
найденных в коллекции образов.
