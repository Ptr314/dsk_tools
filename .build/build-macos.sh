...
# Simple macOS release build script for the command line tools
...
BUILD_DIR="$SCRIPT_DIR/build/macos_${ARCH}"
RELEASE_DIR="$SCRIPT_DIR/release/dsk_tools-${VERSION}-macos-${ARCH}"

echo "Building $TOOLS for macOS ($ARCH)..."
...
# Create zip file
ZIP_FILE="$SCRIPT_DIR/release/dsk_tools-${VERSION}-macos-${ARCH}.zip"
